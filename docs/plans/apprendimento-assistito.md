...
## In questo piano: come si insegnano

Valgono il **vincolo zero** e il §6.3 senza sconti. In particolare:

- le regole grammaticali si insegnano **in lingua naturale** («a singular
  subject takes a singular verb»), mai dichiarando predicati;
- ogni regola chiusa deve reggere su **held-out**, in **due lingue** dove la
  regola esiste in entrambe, e **ritrattarsi parlando**;
- il `.p0` si insegna mostrando **frammenti**, non elencando la sintassi: e' la
  stessa disciplina con cui si e' insegnata una relazione nuova al `gen505`.
