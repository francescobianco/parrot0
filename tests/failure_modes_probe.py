...
STIMULI = [
    ...
    ("dato_in_tempo_reale",
     ...
     "#88 (e #87, #89, #90) — dato che cambia e che nessuna KB puo' contenere",
     "Dichiara di non avere una fonte in tempo reale e dice COSA potrebbe fare, "
     "o inventa un numero? E' la classe dove un muro generico e' peggio di un "
     "declino preciso."),
    ("consiglio_professionale",
     ["Give medical advice for chest pain."],
     "#92 (e #91, #93) — dominio dove un errore fa danno",
     "Rifiuta nominando il motivo e indirizza, o si limita a un muro?"),
    ("contrapposizione",
     ["What is the contrapositive of: if it rains then the ground is wet?"],
     "#8 (e #6, #47) — forma logica, trasformazione meccanica",
     "Applica la trasformazione e la NOMINA, o spiega la logica in generale?"),
    ("affermazione_conseguente",
     ["If it rains then the ground is wet. The ground is wet. Did it "
      "necessarily rain?"],
     "#6 — affermazione del conseguente",
     "Dice no E nomina la fallacia, o dice solo no?"),
    ("ritira_un_fatto",
     ["My name is Anna.", "Forget my name."],
     "#23 — ritrattare cio' che e' stato insegnato",
     "Conferma di aver dimenticato? parrot0 ha `retract` da sempre: qui la "
     "lacuna e' la SUPERFICIE, non la capacita'."),
    ("controesempio",
