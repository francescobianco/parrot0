...
- Learning event: `learn_2026_06_28t05_46_52z_algorithm`
- Operational log: `kb/learning/logs/learn_2026_06_28t05_46_52z_algorithm.json`
- Domain: `computer_science`
- Source: https://en.wikipedia.org/wiki/Algorithm
- Wikipedia revision: `1360948503`
- Processed: `2026-06-28T05:46:52Z`

## Learned Concept

finite sequence of mathematically rigorous instructions, typically used to solve a class of specific problems or to...
...
The Jacquard loom, a precursor to punch cards, and telephone switching machines led to the development of the first computers. By the mid-19th century, the telegraph, was in use throughout the world. By the late 19th century, ticker tape () and punch cards (c. 1890) were developed. Then came the teleprinter () with its punched-paper use of Baudot code on tape.
...
In 1928, a partial formalization of the modern concept of algorithms began with attempts to solve David Hilbert's Entscheidungsproblem (decision problem). Later formalizations were framed as attempts to define "effective calculability" or "effective method". Those formalizations included the Godel--Herbrand--Kleene recursive functions of 1930, 1934 and 1935, Alonzo Church's lambda calculus of 1936, Emil Post's Formulation 1 of 1936, and Alan Turing's Turing machines of 1936--37 and 1939.
...
Any algorithm can be computed by any Turing complete model. Turing completeness only requires four instruction types--conditional GOTO, unconditional GOTO, assignment, HALT. Tausworthe augments the three Bohm-Jacopini canonical structures: SEQUENCE, IF-THEN-ELSE, and WHILE-DO, with two more: DO-WHILE and CASE. An additional benefit of a structured program is that it lends itself to proofs of correctness using mathematical induction.
...
1. Las Vegas algorithms always return the correct answer, but their running time is only probabilistically bound, e.g. ZPP.
...
1. Assume the first number in the set is the largest.
1. For each remaining number in the set: if this number is greater than the current largest, it becomes the new largest.
1. When there are no unchecked numbers left in the set, consider the current largest number to be the largest in the set.
...
-
- Davis gives commentary before each article. Papers of Godel, Alonzo Church, Turing, Rosser, Kleene, and Emil Post are included; those cited in the article are listed here by author's name.
- Davis offers concise biographies of Leibniz, Boole, Frege, Cantor, Hilbert, Godel and Turing with von Neumann as the show-stealing villain. Very brief bios of Joseph-Marie Jacquard, Babbage, Ada Lovelace, Claude Shannon, Howard Aiken, etc.
-
-
-
- ,
...
-
-
- Jon Kleinberg, Eva Tardos(2006): Algorithm Design, Pearson/Addison-Wesley, ISBN 978-0-32129535-4
